...
static struct PyNET_STRUCT_ITEM gi1002[] = {
	GI1002_ENTRY(comment, NSI_WSTR, 0), // @prop string/<o PyUnicode>|comment|
	{NULL}
};

// @object PyGROUP_INFO_1005|A dictionary holding the information in a Win32 GROUP_INFO_1005 structure.
static struct PyNET_STRUCT_ITEM gi1005[] = {
	GI1005_ENTRY(attributes, NSI_DWORD, 0),// @prop int|attributes|
	{NULL}
};
...
static struct PyNET_STRUCT_ITEM lgmi0[] = {
	LGMI0_ENTRY(sid, NSI_SID, 0),// @prop <o PySID>|sid|
	{NULL}
};
...
static struct PyNET_STRUCT_ITEM lgmi1[] = {
	LGMI1_ENTRY(sid, NSI_SID, 0),// @prop <o PySID>|sid|
...
static struct PyNET_STRUCT_ITEM lgmi2[] = {
	...
	LGMI2_ENTRY(domainandname, NSI_WSTR, 0),// @prop string/<o PyUnicode>|domainandname|string containing the name of the member prefixed by the domain name and the "\" separator character
	{NULL}
};
...
static struct PyNET_STRUCT_ITEM lgmi3[] = {
	LGMI3_ENTRY(domainandname, NSI_WSTR, 0),// @prop string/<o PyUnicode>|domainandname|string containing the name of the member prefixed by the domain name and the "\" separator character
	{NULL}
};

...
PyObject *PyCRYPTHASH::getattro(PyObject *self, PyObject *obname)
{
...
PyCRYPTHASH::~PyCRYPTHASH(void)
{
	CryptDestroyHash(hcrypthash);
}

void PyCRYPTHASH::deallocFunc(PyObject *ob)
{
	delete (PyCRYPTHASH *)ob;
}
...
PyObject *PyCRYPTHASH::PyCryptSignHash(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "k|k:CryptSignHash", keywords,
...
PyObject *PyCRYPTHASH::PyCryptGetHashParam(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "k|k:CryptGetHashParam", keywords,

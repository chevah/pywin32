...
struct PyMethodDef PyCERT_CONTEXT::methods[] = {
	...
	{"CertEnumCertificateContextProperties", (PyCFunction)PyCERT_CONTEXT::PyCertEnumCertificateContextProperties, METH_NOARGS},
	// @pymeth CryptAcquireCertificatePrivateKey|Retrieves the private key associated with the certificate
	{"CryptAcquireCertificatePrivateKey", (PyCFunction)PyCERT_CONTEXT::PyCryptAcquireCertificatePrivateKey, METH_KEYWORDS|METH_VARARGS},
	...
	{"CertSerializeCertificateStoreElement", (PyCFunction)PyCERT_CONTEXT::PyCertSerializeCertificateStoreElement, METH_KEYWORDS|METH_VARARGS},
	// @pymeth CertVerifySubjectCertificateContext|Checks the validity of the certificate
	{"CertVerifySubjectCertificateContext", (PyCFunction)PyCERT_CONTEXT::PyCertVerifySubjectCertificateContext, METH_KEYWORDS|METH_VARARGS},
	...
	{"CertGetCertificateContextProperty", (PyCFunction)PyCERT_CONTEXT::PyCertGetCertificateContextProperty, METH_KEYWORDS|METH_VARARGS},
	// @pymeth CertSetCertificateContextProperty|Sets a property for a certificate
	{"CertSetCertificateContextProperty", (PyCFunction)PyCERT_CONTEXT::PyCertSetCertificateContextProperty, METH_KEYWORDS|METH_VARARGS},
	{NULL}
};


PyTypeObject PyCERT_CONTEXTType =
{
	PYWIN_OBJECT_HEAD
	"PyCERT_CONTEXT",
...
PyObject *PyCERT_CONTEXT::PyCertFreeCertificateContext (PyObject *self, PyObject *args)
{
	...
	bsuccess = CertFreeCertificateContext (pccert_context);
...
// @pymethod (int,<o PyCRYPTPROV>)|PyCERT_CONTEXT|CryptAcquireCertificatePrivateKey|Retrieves the private key associated with the certificate
...
PyObject *PyCERT_CONTEXT::PyCryptAcquireCertificatePrivateKey(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	BOOL bsuccess;
	Py_BEGIN_ALLOW_THREADS
	bsuccess = CryptAcquireCertificatePrivateKey(pccert_context, flags, reserved,
		&hcryptprov, &keyspec, &callerfree);
	Py_END_ALLOW_THREADS
	if (!bsuccess)
...
// @pymethod tuple|PyCERT_CONTEXT|CertGetEnhancedKeyUsage|Finds the enhanced key usage property and/or extension for the certificate
...
// @pymethod int|PyCERT_CONTEXT|CertGetIntendedKeyUsage|Returns the intended key usage from the certificate extensions (szOID_KEY_USAGE or szOID_KEY_ATTRIBUTES)
...
PyObject *PyCERT_CONTEXT::PyCertGetIntendedKeyUsage(PyObject *self, PyObject *args)
{
	...
	BOOL bsuccess;
	Py_BEGIN_ALLOW_THREADS
	bsuccess = CertGetIntendedKeyUsage(pccert_context->dwCertEncodingType, pccert_context->pCertInfo, (BYTE *)&buf, bufsize);
	Py_END_ALLOW_THREADS
	if (!bsuccess)
...
PyObject *PyCERT_CONTEXT::PyCertVerifySubjectCertificateContext(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	PCCERT_CONTEXT pccert_context=((PyCERT_CONTEXT *)self)->GetPCCERT_CONTEXT();
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "Ok:CertVerifySubjectCertificateContext", keywords,
		&obissuer,	// @pyparm <o PyCERT_CONTEXT>|Issuer||Certificate of authority that issued the certificate
		&flags))	// @pyparm int|Flags||Combination of CERT_STORE_REVOCATION_FLAG,CERT_STORE_SIGNATURE_FLAG and CERT_STORE_TIME_VALIDITY_FLAG indicating which checks should be performed
		return NULL;
...
// @pymethod object|PyCERT_CONTEXT|CertGetCertificateContextProperty|Retrieves the specified property from the certificate
...
PyObject *PyCERT_CONTEXT::PyCertGetCertificateContextProperty(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	if (pcbData>0){
		...
		if (pvData==NULL)
			return PyErr_Format(PyExc_MemoryError,"CertGetCertificateContextProperty: unable to allocate %d bytes", pcbData);
	...
	switch (dwPropId){
		...
		case CERT_KEY_PROV_HANDLE_PROP_ID:	// @flag CERT_KEY_PROV_HANDLE_PROP_ID|<o PyCRYPTPROV>
			...
			break;
		case CERT_SUBJECT_PUBLIC_KEY_MD5_HASH_PROP_ID:	// @flag CERT_SUBJECT_PUBLIC_KEY_MD5_HASH_PROP_ID|String containing a hash
		case CERT_ISSUER_PUBLIC_KEY_MD5_HASH_PROP_ID:	// @flag CERT_ISSUER_PUBLIC_KEY_MD5_HASH_PROP_ID|String containing a hash
			ret=PyString_FromStringAndSize((char *)pvData, pcbData);
		...
		case CERT_KEY_CONTEXT_PROP_ID:	// @flag CERT_KEY_CONTEXT_PROP_ID|Dict representing CERT_KEY_CONTEXT struct
			ret = Py_BuildValue("{s:N, s:k}",
				"CryptProv", new PyCRYPTPROV(((PCERT_KEY_CONTEXT)pvData)->hCryptProv),
		...
		case CERT_CROSS_CERT_DIST_POINTS_PROP_ID: // CRYPT_DATA_BLOB which contains encoded CROSS_CERT_DIST_POINTS_INFO (X509_CROSS_CERT_DIST_POINTS)
		default:
...
PyObject *PyCERT_CONTEXT::PyCertSetCertificateContextProperty(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	switch (prop){
		case CERT_ARCHIVED_PROP_ID:	// @flag CERT_ARCHIVED_PROP_ID|None causes Archived flag to be cleared, any other causes it to be set
			pvData=&cdb;	// no actual data, non-NULL pvData indicates presence of flag
			break;
		case CERT_DATE_STAMP_PROP_ID:	// @flag CERT_DATE_STAMP_PROP_ID|<o PyTime> specifying when cert was added to store
		...
		case CERT_SUBJECT_PUBLIC_KEY_MD5_HASH_PROP_ID:	// @flag CERT_SUBJECT_PUBLIC_KEY_MD5_HASH_PROP_ID|String containing the hash
		case CERT_ISSUER_PUBLIC_KEY_MD5_HASH_PROP_ID:	// @flag CERT_ISSUER_PUBLIC_KEY_MD5_HASH_PROP_ID|String containing the hash
		...
		// @flag CERT_ENHKEY_USAGE_PROP_ID|String containing an encoded <o PyCTL_USAGE>.  Use <om cryptoapi.CryptEncodeObjectEx> with X509_ENHANCED_KEY_USAGE.

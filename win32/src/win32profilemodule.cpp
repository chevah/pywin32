...
// @object PyPROFILEINFO|Dictionary containing data to fill a PROFILEINFO struct, to be passed to <om win32profile.LoadUserProfile>.
...
BOOL PyWinObject_AsPROFILEINFO(PyObject *ob, LPPROFILEINFO pi)
{
	...
	PyObject *obUserName=Py_None, *obProfilePath=Py_None, *obDefaultPath=Py_None,
		*obServerName=Py_None, *obPolicyPath=Py_None, *obhProfile=Py_None;
...
PyObject *PyLoadUserProfile(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OO:LoadUserProfile", keywords,
...
static PyObject *
PyGetProfilesDirectory(PyObject * self, PyObject * args, PyObject *kwargs)
{
...
static PyObject *
PyGetAllUsersProfileDirectory(PyObject * self, PyObject * args, PyObject *kwargs)
{
	static char *keywords[]={NULL};
...
static PyObject *
PyGetDefaultUserProfileDirectory(PyObject * self, PyObject * args, PyObject *kwargs)
{
	static char *keywords[]={NULL};
...
PyObject *PyDeleteProfile(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O|OO:DeleteProfile", keywords,
		&obstrsid,			// @pyparm <o PyUnicode>|SidString||String representation of user's Sid.  See <om win32security.ConvertSidToStringSid>.
...
PyObject *PyCreateEnvironmentBlock(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	PyObject *obhToken=NULL, *ret=NULL;
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "Ol:CreateEnvironmentBlock", keywords,
...
//@pymethod <o PyUnicode>|win32profile|ExpandEnvironmentStringsForUser|Replaces environment variables in a string with per-user values
PyObject *PyExpandEnvironmentStringsForUser(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OO:ExpandEnvironmentStringsForUser", keywords,
...
static struct PyMethodDef win32profile_functions[] = {
	...
	{"CreateEnvironmentBlock",	(PyCFunction)PyCreateEnvironmentBlock, METH_VARARGS|METH_KEYWORDS, "Retrieves environment variables for a user"},
	...
	{"GetEnvironmentStrings",	(PyCFunction)PyGetEnvironmentStrings,METH_VARARGS|METH_KEYWORDS, "Retrieves environment variables for current process"},
	//@pymeth GetProfilesDirectory|Retrieves directory where user profiles are stored
	{"GetProfilesDirectory",	(PyCFunction)PyGetProfilesDirectory,METH_VARARGS|METH_KEYWORDS, "Retrieves directory where user profiles are stored"},
	//@pymeth GetProfileType|Returns type of current user's profile
	{"GetProfileType",	(PyCFunction)PyGetProfileType,METH_VARARGS|METH_KEYWORDS, "Returns type of current user's profile"},
	// @pymeth GetUserProfileDirectory|Returns profile directory for a logon token
	{"GetUserProfileDirectory",	(PyCFunction)PyGetUserProfileDirectory,METH_VARARGS|METH_KEYWORDS, "Returns profile directory for a logon token"},
	//@pymeth LoadUserProfile|Load user settings for a login token
	{"LoadUserProfile",	(PyCFunction)PyLoadUserProfile, METH_VARARGS|METH_KEYWORDS, "Load user settings for a login token"},
	//@pymeth UnloadUserProfile|Unload profile loaded by LoadUserProfile
	{"UnloadUserProfile",	(PyCFunction)PyUnloadUserProfile, METH_VARARGS|METH_KEYWORDS, "Unload profile loaded by LoadUserProfile"},
	{NULL,			NULL}
};
...
PYWIN_MODULE_INIT_FUNC(win32profile)
{
	...
	if (hmodule!=NULL){
		...
		pfnGetAllUsersProfileDirectory=(GetAllUsersProfileDirectoryfunc)GetProcAddress(hmodule,"GetAllUsersProfileDirectoryW");
		pfnGetDefaultUserProfileDirectory=(GetDefaultUserProfileDirectoryfunc)GetProcAddress(hmodule,"GetDefaultUserProfileDirectoryW");

...
// @pymethod |PySECURITY_DESCRIPTOR|SetSecurityDescriptorSacl|Replaces system access control list (SACL) in the security descriptor.
...
// @pymethod <o PyACL>|PySECURITY_DESCRIPTOR|GetSecurityDescriptorDacl|Return the discretionary ACL of the security descriptor.
...
// @pymethod (int,int)|PySECURITY_DESCRIPTOR|GetSecurityDescriptorControl|Returns tuple of Control bit flags and revision of SD.
...
// @pymethod |PySECURITY_DESCRIPTOR|SetSecurityDescriptorControl|Sets the control bit flags related to inheritance for a security descriptor
...
struct PyMethodDef PySECURITY_DESCRIPTOR::methods[] = {
	...
	{"SetSecurityDescriptorControl", PySECURITY_DESCRIPTOR::SetSecurityDescriptorControl, 1}, // @pymeth SetSecurityDescriptorControl|Sets control bitmask of a security descriptor
	{NULL}
};

...
PyObject *PySMALL_RECT::tp_new(PyTypeObject *tp, PyObject *args, PyObject *kwargs)
{
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "|HHHH:PySMALL_RECTType", keywords,
...
PyObject *PySMALL_RECT::tp_str(PyObject *self)
{
	...
	chars_printed=_snprintf(buf, 100, "PySMALL_RECTType(Left=%d,Top=%d,Right=%d,Bottom=%d)", 
		sr.Left, sr.Top, sr.Right, sr.Bottom);
	if (chars_printed<0){
...
PyObject *PyCOORD::tp_new(PyTypeObject *tp, PyObject *args, PyObject *kwargs)
{
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "|HH:PyCOORDType", keywords,
		&coord.X, &coord.Y))
		return NULL;
...
void PyCOORD::deallocFunc(PyObject *ob)
{
	delete (PyCOORD *)ob;
}
...
struct PyMethodDef PyConsoleScreenBuffer::methods[] = {
	...
	{"SetConsoleTextAttribute", (PyCFunction)PyConsoleScreenBuffer::PySetConsoleTextAttribute, METH_VARARGS|METH_KEYWORDS, 
	...
	{"SetConsoleCursorPosition", (PyCFunction)PyConsoleScreenBuffer::PySetConsoleCursorPosition, METH_VARARGS|METH_KEYWORDS, 
	...
	{"SetConsoleScreenBufferSize", (PyCFunction)PyConsoleScreenBuffer::PySetConsoleScreenBufferSize, METH_VARARGS|METH_KEYWORDS, 
	...
	{"FillConsoleOutputAttribute", (PyCFunction)PyConsoleScreenBuffer::PyFillConsoleOutputAttribute, METH_VARARGS|METH_KEYWORDS,
	...
	{"FillConsoleOutputCharacter", (PyCFunction)PyConsoleScreenBuffer::PyFillConsoleOutputCharacter, METH_VARARGS|METH_KEYWORDS,
	...
	{"ReadConsoleOutputCharacter", (PyCFunction)PyConsoleScreenBuffer::PyReadConsoleOutputCharacter, METH_VARARGS|METH_KEYWORDS,
	...
	{"ReadConsoleOutputAttribute", (PyCFunction)PyConsoleScreenBuffer::PyReadConsoleOutputAttribute, METH_VARARGS|METH_KEYWORDS,
	...
	{"WriteConsoleOutputCharacter", (PyCFunction)PyConsoleScreenBuffer::PyWriteConsoleOutputCharacter, METH_VARARGS|METH_KEYWORDS,
	...
	{"WriteConsoleOutputAttribute", (PyCFunction)PyConsoleScreenBuffer::PyWriteConsoleOutputAttribute, METH_VARARGS|METH_KEYWORDS,
...
// @pymethod (Size, bVisible)|PyConsoleScreenBuffer|GetConsoleCursorInfo|Retrieves size and visibility of console's cursor
// @rdesc Returns the size of the console's cursor expressed as a percentage of character size, and a boolen indicating if cursor is visible
...
PyObject *PyConsoleScreenBuffer::PySetConsoleCursorInfo(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	CONSOLE_CURSOR_INFO cci;
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "kk:SetConsoleCursorInfo", keywords,
...
PyObject *PyConsoleScreenBuffer::PySetConsoleMode(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	DWORD mode;
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "k:SetConsoleMode", keywords,
...
PyObject *PyConsoleScreenBuffer::PyWriteConsole(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O:WriteConsole", keywords, 
...
PyObject *PyConsoleScreenBuffer::PySetConsoleTextAttribute(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "H:SetConsoleTextAttribute", keywords,
		&Attributes))   // @pyparm int|Attributes||Attributes to be set, combination of FOREGROUND_*, BACKGROUND_*, and COMMON_LVB_* constants
		return NULL;
...
PyObject *PyConsoleScreenBuffer::PyGetConsoleScreenBufferInfo(PyObject *self, PyObject *args)
{
	...
	return Py_BuildValue("{s:N,s:N,s:H,s:N,s:N}",
		"Size", PyWinObject_FromCOORD(&info.dwSize),
		"CursorPosition", PyWinObject_FromCOORD(&info.dwCursorPosition),
		"Attributes", info.wAttributes,
		"Window", PyWinObject_FromSMALL_RECT(&info.srWindow),
		"MaximumWindowSize", PyWinObject_FromCOORD(&info.dwMaximumWindowSize));
}

// @pymethod <o PyCOORD>|PyConsoleScreenBuffer|GetLargestConsoleWindowSize|Returns the largest possible size for the console's window
...
// @pymethod int|PyConsoleScreenBuffer|FillConsoleOutputAttribute|Set text attributes for a consecutive series of characters
...
PyObject *PyConsoleScreenBuffer::PyFillConsoleOutputAttribute(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "HlO:FillConsoleOutputAttribute", keywords,
		&attr,		// @pyparm int|Attribute||Text attributes to be set, combination of FOREGROUND_*, BACKGROUND_*, and COMMON_LVB_* constants
...
// @pymethod int|PyConsoleScreenBuffer|FillConsoleOutputCharacter|Sets consecutive character positions to a specified character
...
PyObject *PyConsoleScreenBuffer::PyReadConsoleOutputCharacter(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	WCHAR *buf=NULL;
	PCOORD pcoord;
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "lO:ReadConsoleOutputCharacter", keywords,
...
// @pymethod (int,...)|PyConsoleScreenBuffer|ReadConsoleOutputAttribute|Retrieves attributes from consecutive character cells
...
PyObject *PyConsoleScreenBuffer::PyReadConsoleOutputAttribute(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	WORD *buf=NULL;
	PCOORD pcoord;
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "lO:ReadConsoleOutputAttribute", keywords,
...
PyObject *PyConsoleScreenBuffer::PyWriteConsoleOutputCharacter(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	WCHAR *buf=NULL;
	PCOORD pcoord;
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OO:WriteConsoleOutputCharacter", keywords,
...
PyObject *PyConsoleScreenBuffer::PyWriteConsoleOutputAttribute(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	PCOORD pcoord;
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OO:WriteConsoleOutputAttribute", keywords,
	...
	if (!PyWinObject_AsUSHORTArray(obattributes, &attributes, &attributecnt, FALSE))
		return NULL;
	if (!WriteConsoleOutputAttribute(((PyConsoleScreenBuffer *)self)->m_handle, 
			attributes, attributecnt, *pcoord, &nbrwritten))
...
PyObject *PyConsoleScreenBuffer::PyScrollConsoleScreenBuffer(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OOOOH:ScrollConsoleScreenBuffer", keywords,
		...
		&obfillchar,		// @pyparm <o PyUNICODE>|FillCharacter||Character to fill in the area left blank by scrolling operation
...
static PyObject *PyGetConsoleSelectionInfo(PyObject *self, PyObject *args)
{
	...
	return Py_BuildValue("{s:l,s:N,s:N}",
		"Flags", csi.dwFlags,
		"SelectionAnchor", PyWinObject_FromCOORD(&csi.dwSelectionAnchor),
		"Selection", PyWinObject_FromSMALL_RECT(&csi.srSelection));
}
...
static PyObject *PyAddConsoleAlias(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OOO:AddConsoleAlias", keywords, 
	...
	if (PyWinObject_AsWCHAR(obsource, &source, FALSE)
		&&PyWinObject_AsWCHAR(obtarget, &target, TRUE)
...
static PyObject *PyGetConsoleAliases(PyObject *self, PyObject *args, PyObject *kwargs)
{
	...
	DWORD buflen;
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O:GetConsoleAliases", keywords, 
	...
	if (PyWinObject_AsWCHAR(obexename, &exename, FALSE)){
		...
		if (buflen==0)
			...
			if (buf==NULL)
				...
				if ((*pfnGetConsoleAliases)(buf, buflen, exename)==0)
...
static PyObject *PyGetConsoleAliasExes(PyObject *self, PyObject *args)
{
	...
	if (buflen==0)
		...
		if (buf==NULL)
			...
			if ((*pfnGetConsoleAliasExes)(buf, buflen)==0)
...
static struct PyMethodDef win32console_functions[] = {
	...
	{"CreateConsoleScreenBuffer", (PyCFunction)PyCreateConsoleScreenBuffer, METH_VARARGS|METH_KEYWORDS, "Creates a new console screen buffer"},     
	...
	{"AttachConsole", (PyCFunction)PyAttachConsole, METH_VARARGS|METH_KEYWORDS, "Attaches calling process to console of another process"},	
	...
	{"GetConsoleProcessList", PyGetConsoleProcessList, METH_VARARGS, "Returns pids of all processes attached to current console"},
	...
	{"GetConsoleOutputCP", PyGetConsoleOutputCP, METH_VARARGS, "Returns the output code page for calling process's console"},
	// @pymeth SetConsoleCP|Sets the input code page for calling process's console
	{"SetConsoleCP", (PyCFunction)PySetConsoleCP, METH_VARARGS|METH_KEYWORDS, "Sets the input code page for calling process's console"},
	// @pymeth SetConsoleOutputCP|Sets the output code page for calling process's console
	{"SetConsoleOutputCP", (PyCFunction)PySetConsoleOutputCP, METH_VARARGS|METH_KEYWORDS, "Sets the output code page for calling process's console"},
	// @pymeth GetConsoleSelectionInfo|Returns info on text selection within the current console
	{"GetConsoleSelectionInfo", PyGetConsoleSelectionInfo, METH_VARARGS, "Returns info on text selection within the current console"},
	...
	{"GetConsoleAliases", (PyCFunction)PyGetConsoleAliases, METH_VARARGS|METH_KEYWORDS, "Retrieves aliases defined under specified executable"},
...
PYWIN_MODULE_INIT_FUNC(win32console)
{
	...
	if (kernel32_dll!=NULL){
		...
		pfnGetConsoleAliasesLength=(GetConsoleAliasesLengthfunc)GetProcAddress(kernel32_dll, "GetConsoleAliasesLengthW");
		pfnGetConsoleAliasExes=(GetConsoleAliasExesfunc)GetProcAddress(kernel32_dll, "GetConsoleAliasExesW");
		pfnGetConsoleAliasExesLength=(GetConsoleAliasExesLengthfunc)GetProcAddress(kernel32_dll,"GetConsoleAliasExesLengthW");

...
{
public:
	PythonOleClientItem( COleDocument* pContainerDoc = NULL ) :
	...
	BOOL BaseOnChangeItemPosition(const CRect& rectPos) {
...
PyObject *
PyCOleClientItem_Create(PyObject *self, PyObject *args)
{
	PyObject *obDoc;
...
// @pymethod |PyCOleClientItem|Draw|Draws the OLE item into the specified bounding rectangle using the specified device context.
...
// @pymethod <o PyIUnknown>|PyCOleClientItem|GetObject|Returns the COM object to the item.  This is the m_lpObject variable in MFC.
...
static struct PyMethodDef PyCOleClientItem_methods[] = {
	...
	{"OnChangeItemPosition",PyCOleClientItem_OnChangeItemPosition, 1}, // @pymeth OnChangeItemPosition|Calls the underlying MFC method.
	...
	{"SetItemRects",        PyCOleClientItem_SetItemRects, 1}, // @pymeth SetItemRects|Sets the bounding rectangle or the visible rectangle of the OLE item.
	{NULL},
};

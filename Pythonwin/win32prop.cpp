...
static struct PyMethodDef ui_propsheet_methods[] = {
	...
	{"OnInitDialog",    ui_propsheet_on_init_dialog,    1}, // @pymeth OnInitDialog|Calls the default MFC OnInitDialog handler.
...
static struct PyMethodDef ui_proppage_methods[] = {
	...
	{"OnQueryCancel",			ui_proppage_on_query_cancel,			1}, // @pymeth OnQueryCancel|Calls the default MFC OnQueryCancel handler.
	{"OnWizardBack",			ui_proppage_on_wizard_back,			1}, // @pymeth OnWizardBack|Calls the default MFC OnWizardBack handler.
	{"OnWizardNext",			ui_proppage_on_wizard_next,			1}, // @pymeth OnWizardNext|Calls the default MFC OnWizardNext handler.
	{"OnWizardFinish",			ui_proppage_on_wizard_finish,			1}, // @pymeth OnWizardFinish|Calls the default MFC OnWizardFinish handler.
	{"OnSetActive",		ui_proppage_on_set_active,			1}, // @pymeth OnSetActive|Calls the default MFC OnSetActive handler.
	{"OnKillActive",	ui_proppage_on_kill_active,			1}, // @pymeth OnKillActive|Calls the default MFC OnKillActive handler.

...
void PyWin_SetViewDocument(CView *pView, CDocument *pDoc)
{
...
static PyObject *
PyCView_on_mouse_activate( PyObject *self, PyObject *args)
{
...
PyObject *
PyCView_on_file_print(PyObject *self, PyObject *args)
{
...
PyObject *
PyCView_on_file_print_preview(PyObject *self, PyObject *args)
{
	CHECK_NO_ARGS2(args, OnFilePrint);
	CProtectedView	*view = (CProtectedView*)PyCView::GetViewPtr (self);
	if (view == NULL)
...
PyObject *
PyCView_on_prepare_printing(PyObject *self, PyObject *args)
{
	PyObject *pyInfo;
...
static struct PyMethodDef PyCView_methods[] = {
	...
	{"OnMouseActivate",         PyCView_on_mouse_activate, 1}, // @pymeth OnMouseActivate|Calls the underlying MFC OnMouseActivate method.
	...
	{"OnFilePrintPreview",      PyCView_on_file_print_preview, 1}, // @pymeth OnFilePrint|Calls the underlying MFC OnFilePrintPreview method.
	{"DoPreparePrinting",      PyCView_do_prepare_printing, 1}, // @pymeth DoPreparePrinting|Calls the underlying MFC DoPreparePrinting method.
	{"OnBeginPrinting",      PyCView_on_begin_printing, 1}, // @pymeth OnBeginPrinting|Calls the underlying MFC OnBeginPrinting method.
	{"OnEndPrinting",      PyCView_on_end_printing, 1}, // @pymeth OnEndPrinting|Calls the underlying MFC OnEndPrinting method.
	{NULL,			NULL}
};
...
static PyObject *
ui_view_set_scale_to_fit_size(PyObject *self, PyObject *args)
{
  CScrollView *pView = PyCScrollView::GetViewPtr (self);
  if (pView == NULL)
	return NULL;
  SIZE size;
  // @pyparm (x,y)|size||The horizontal and vertical sizes to which the view is to be scaled. The scroll view's size is measured in logical units.
...
static PyObject *
ui_view_update_bars (PyObject *self, PyObject *args)
{
  CHECK_NO_ARGS(args);
  CScrollView	*view = PyCScrollView::GetViewPtr (self);
  if (view == NULL)
...
PyObject *
PyCView_on_command(PyObject *self, PyObject *args)
{
...
static struct PyMethodDef PyCScrollView_methods[] = {
	...
	{"SetScaleToFitSize",		ui_view_set_scale_to_fit_size, 1}, // @pymeth SetScaleToFitSize|Scales the viewport size to the current window size automatically.
...
PyObject *
PyCCtrlView_on_command(PyObject *self, PyObject *args)
{
	// @xref <vm PyCWnd.OnCommand>
	// @pyparm int|wparam||
	// @pyparm int|lparam||
...
static struct PyMethodDef PyCCtrlView_methods[] = {
	{"OnCommand",        PyCCtrlView_on_command, 1}, // @pymeth OnCommand|Calls the standard Python framework OnCommand handler
	{NULL, NULL}
};
...
PyObject *
PyCEditView_on_command(PyObject *self, PyObject *args)
{
	// @xref <vm PyCWnd.OnCommand>
	// @pyparm int|wparam||
	// @pyparm int|lparam||
...
static struct PyMethodDef ui_edit_window_methods[] = {
	...
	{"OnCommand",       PyCEditView_on_command, 1}, // @pymeth OnCommand|Calls the standard Python framework OnCommand handler
	{NULL, NULL}
};
...
PyObject *
PyCListView_on_command(PyObject *self, PyObject *args)
{
	// @xref <vm PyCWnd.OnCommand>
	// @pyparm int|wparam||
	// @pyparm int|lparam||
...
static struct PyMethodDef ui_list_view_methods[] = {
	...
	{"OnCommand",   PyCListView_on_command, 1}, // @pymeth OnCommand|Calls the standard Python framework OnCommand handler
	{NULL, NULL}
};
...
PyObject *
PyCTreeView_on_command(PyObject *self, PyObject *args)
{
	// @xref <vm PyCWnd.OnCommand>
	// @pyparm int|wparam||
	// @pyparm int|lparam||
...
static struct PyMethodDef ui_tree_view_methods[] = {
	...
	{"OnCommand", PyCTreeView_on_command, 1}, // @pymeth OnCommand|Calls the standard Python framework OnCommand handler
	{NULL, NULL}
};
...
PyObject *
PyCFormView_on_command(PyObject *self, PyObject *args)
{
	// @xref <vm PyCWnd.OnCommand>
	// @pyparm int|wparam||
	// @pyparm int|lparam||
...
static struct PyMethodDef PyCFormView_methods[] = {
	{"OnCommand",        PyCFormView_on_command, 1}, // @pymeth OnCommand|Calls the standard Python framework OnCommand handler
	{NULL, NULL}
};

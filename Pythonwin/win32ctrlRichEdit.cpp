...
PyObject *PyCRichEditCtrl_create(PyObject *self, PyObject *args)
{
	...
	// @comm This method only creates the RichEdit object. To create the window, (ie, the control itself), call <om PyCRichEdit.CreateWindow>
}
...
static PyObject *
PyCRichEditCtrl_clear(PyObject *self, PyObject *args)
{
	CHECK_NO_ARGS(args);
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit	)
...
static PyObject *
PyCRichEditCtrl_find_text(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
// @pymethod (tuple)|PyCRichEditCtrl|GetCharPos|Returns the location of the top-left corner of the character specified by charPos.
static PyObject *
PyCRichEditCtrl_get_char_pos(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
// @pymethod (tuple)|PyCRichEditCtrl|GetDefaultCharFormat|Returns the current default character formatting attributes in this <o PyCRichEditCtrl> object.
static PyObject *
PyCRichEditCtrl_get_default_char_format(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
static PyObject *
PyCRichEditCtrl_get_event_mask(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
static PyObject *
PyCRichEditCtrl_get_line_count(PyObject *self, PyObject *args)
{
	CHECK_NO_ARGS(args);
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit	)
...
static PyObject *
PyCRichEditCtrl_get_first_visible(PyObject *self, PyObject *args)
{
	CHECK_NO_ARGS(args);
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
...
static PyObject *
PyCRichEditCtrl_get_para_format(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
static PyObject *
PyCRichEditCtrl_get_selection_char_format(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
static PyObject *
PyCRichEditCtrl_line_index(PyObject *self, PyObject *args)
{
...
static PyObject *
PyCRichEditCtrl_line_scroll(PyObject *self, PyObject *args)
{
	// @comm This method only works on multi-linr edit controls.
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
...
static PyObject *
PyCRichEditCtrl_line_from_char(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
static PyObject *
PyCRichEditCtrl_get_line(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
static PyObject *
PyCRichEditCtrl_set_background_color(PyObject *self, PyObject *args)
{
	BOOL bSysColor;
	int cr = 0;
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
	// @pyparm int|bSysColor||Indicates if the background color should be set to the system value. If this value is TRUE, cr is ignored.
...
static PyObject *
PyCRichEditCtrl_set_event_mask(PyObject *self, PyObject *args)
{
	int event;
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
...
// @pymethod |PyCRichEditCtrl|SetDefaultCharFormat|Sets the current default character formatting attributes in this <o PyCRichEditCtrl> object.
static PyObject *
PyCRichEditCtrl_set_default_char_format(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
static PyObject *
PyCRichEditCtrl_set_word_char_format(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
static PyObject *
PyCRichEditCtrl_set_para_format(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
static PyObject *
PyCRichEditCtrl_set_selection_char_format(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
static PyObject *
PyCRichEditCtrl_set_sel_and_char_format(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
static PyObject *
PyCRichEditCtrl_set_options(PyObject *self, PyObject *args)
{
	int op, flags;
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
...
static PyObject *
PyCRichEditCtrl_set_readonly(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
static PyObject *
PyCRichEditCtrl_stream_in(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
static PyObject *
PyCRichEditCtrl_stream_out(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
static PyObject *
PyCRichEditCtrl_get_text_length(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
static PyObject *
PyCRichEditCtrl_get_modify(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
static PyObject *
PyCRichEditCtrl_set_modify(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
static PyObject *
PyCRichEditCtrl_set_target_device(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
static PyObject *
PyCRichEditCtrl_get_sel_text(PyObject *self, PyObject *args)
{
	CRichEditCtrl *pEdit = GetRichEditCtrl(self);
	if (!pEdit)
		return NULL;
...
static struct PyMethodDef PyCRichEditCtrl_methods[] = {
	...
	{"GetCharPos",      PyCRichEditCtrl_get_char_pos,       1}, // @pymeth GetCharPos|Returns te location of the top-left corner of the specified character.
	{"GetDefaultCharFormat", PyCRichEditCtrl_get_default_char_format, 1}, // @pymeth GetDefaultCharFormat|Returns the current default character formatting attributes in this <o PyCRichEditCtrl> object.
	{"GetEventMask",    PyCRichEditCtrl_get_event_mask,     1}, // @pymeth GetEventMask|Returns the current event mask.
	{"GetSelectionCharFormat", PyCRichEditCtrl_get_selection_char_format, 1}, // @pymeth GetSelectionCharFormat|Returns the character formatting attributes of the current selection in this <o PyCRichEditCtrl> object.
	{"GetFirstVisibleLine",PyCRichEditCtrl_get_first_visible,1}, // @pymeth GetFirstVisibleLine|Returns zero-based index of the topmost visible line.
	{"GetParaFormat",   PyCRichEditCtrl_get_para_format,    1}, // @pymeth GetParaFormat|Returns the formatting of the current paragraph.
	...
	{"GetTextLength",   PyCRichEditCtrl_get_text_length,    1}, // @pymeth GetTextLength|Returns the length of the text in the control.
	...
	{"GetLineCount",	PyCRichEditCtrl_get_line_count,		1}, // @pymeth GetLineCount|Returns the number of lines in an edit control.
	{"LimitText",	    PyCRichEditCtrl_limit_text,			1}, // @pymeth LimitText|Sets max length of text that user can enter
	{"LineFromChar",	PyCRichEditCtrl_line_from_char,		1}, // @pymeth LineFromChar|Returns the line number of a given character.
	{"LineIndex",		PyCRichEditCtrl_line_index,			1}, // @pymeth LineIndex|Returns the line index
	{"LineScroll",		PyCRichEditCtrl_line_scroll,		1}, // @pymeth LineScroll|Scroll the control vertically and horizontally
	{"Paste",			PyCRichEditCtrl_paste,				1}, // @pymeth Paste|Pastes the contents of the clipboard into the edit control.
	{"ReplaceSel",		PyCRichEditCtrl_replace_sel,		1}, // @pymeth ReplaceSel|Replace the selection with the specified text.
	{"SetBackgroundColor", PyCRichEditCtrl_set_background_color, 1}, // @pymeth SetBackgroundColor|Sets the background color for the control.
	{"SetDefaultCharFormat", PyCRichEditCtrl_set_default_char_format, 1}, // @pymeth SetDefaultCharFormat|Sets the current default character formatting attributes in this PyCRichEditCtrl object.
	{"SetEventMask",    PyCRichEditCtrl_set_event_mask,     1}, // @pymeth SetEventMask|Sets the event motification mask.
	{"SetSelectionCharFormat", PyCRichEditCtrl_set_selection_char_format, 1}, // @pymeth SetSelectionCharFormat|Sets the character formatting attributes for the selection in this PyCRichEditCtrl object.
	...
	{"SetReadOnly",		PyCRichEditCtrl_set_readonly,		1}, // @pymeth SetReadOnly|Set the read only status of an edit control.
	{"SetSel",			PyCRichEditCtrl_set_sel,			1}, // @pymeth SetSel|Changes the selection in an edit control.
	{"SetSelAndCharFormat", PyCRichEditCtrl_set_sel_and_char_format, 1}, // @pymeth SetSelAndCharFormat|Sets the selection and the char format.
	{"SetTargetDevice",	PyCRichEditCtrl_set_target_device,	1}, // @pymeth SetTargetDevice|Sets the target device for the control
	{"StreamIn",		PyCRichEditCtrl_stream_in,			1}, // @pymeth StreamIn|Invokes a callback to stream data into the control.
	{"StreamOut",		PyCRichEditCtrl_stream_out,			1}, // @pymeth StreamOut|Invokes a callback to stream data out of the control.
	{NULL,			NULL}
};

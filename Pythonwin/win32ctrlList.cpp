...
static struct PyMethodDef PyCListCtrl_methods[] = {
	...
	{"GetItemRect",    PyCListCtrl_GetItemRect, 1}, // @pymeth GetItemRect|Retrieves the bounding rectangle of a list view item.
	{"GetEditControl",   PyCListCtrl_GetEditControl, 1}, // @pymeth GetEditControl|Retrieves the handle of the edit control used to edit the specified list view item.
	{"EditLabel",      PyCListCtrl_EditLabel,  1}, // @pymeth EditLabel|Edits a specified list view item in-place.
	{"EnsureVisible",  PyCListCtrl_EnsureVisible,  1}, // @pymeth EnsureVisible|Ensures that a list view item is visible in its list view control.
	{"CreateDragImage",PyCListCtrl_CreateDragImage,  1}, // @pymeth CreateDragImage|Creates a dragging bitmap for the specified list view item.

...
static struct PyMethodDef PyIDebugDocumentTextEvents_methods[] =
{
	...
	{ "onReplaceText", PyIDebugDocumentTextEvents::onReplaceText, 1 }, // @pymeth onReplaceText|Description of onReplaceText
	{ "onUpdateTextAttributes", PyIDebugDocumentTextEvents::onUpdateTextAttributes, 1 }, // @pymeth onUpdateTextAttributes|Description of onUpdateTextAttributes
	{ "onUpdateDocumentAttributes", PyIDebugDocumentTextEvents::onUpdateDocumentAttributes, 1 }, // @pymeth onUpdateDocumentAttributes|Description of onUpdateDocumentAttributes
	{ NULL }
};

PyComTypeObject PyIDebugDocumentTextEvents::type("PyIDebugDocumentTextEvents",
		&PyIUnknown::type,
		sizeof(PyIDebugDocumentTextEvents),
		PyIDebugDocumentTextEvents_methods,
...
// Std delegation
STDMETHODIMP PyGDebugDocumentTextEvents::onDestroy(
		void)
{
	PY_GATEWAY_METHOD;

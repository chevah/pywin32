...
{
	{ "EnumExpressionContexts", PyIProvideExpressionContexts::EnumExpressionContexts, 1 }, // @pymeth EnumExpressionContexts|Description of EnumExpressionContexts
	{ NULL }
};

PyComTypeObject PyIProvideExpressionContexts::type("PyIProvideExpressionContexts",
		&PyIUnknown::type,
		...
		/* [out] */ IEnumDebugExpressionContexts __RPC_FAR *__RPC_FAR * ppedsf)
{
	...
	if (!PyCom_InterfaceFromPyInstanceOrObject(obppedsf, IID_IEnumDebugExpressionContexts, (void **)ppedsf, TRUE /* bNoneOK */))

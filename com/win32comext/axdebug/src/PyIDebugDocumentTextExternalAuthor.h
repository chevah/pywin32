...
protected:
	...
	PYGATEWAY_MAKE_SUPPORT(PyGDebugDocumentTextExternalAuthor, IDebugDocumentTextExternalAuthor, IID_IDebugDocumentTextExternalAuthor)

	// IDebugDocumentTextExternalAuthor
	STDMETHOD(GetPathName)(
		BSTR __RPC_FAR * pbstrLongName,
		BOOL __RPC_FAR * pfIsOriginalFile);

	STDMETHOD(GetFileName)(
		BSTR __RPC_FAR * pbstrShortName);

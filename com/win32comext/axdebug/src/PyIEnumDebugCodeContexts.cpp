...
// @pymethod <o PyIEnumDebugCodeContexts>|PyIEnumDebugCodeContexts|Clone|Creates another enumerator that contains the same enumeration state as the current one

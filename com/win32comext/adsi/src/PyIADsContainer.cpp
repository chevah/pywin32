/*
 * FILE : O:\src\pywin32\com\win32comext\adsi\src\PyIADsContainer.cpp
 * 
...
// @pyswig |put_Hints|
// @pyparm object|val||
PyObject *PyIADsContainer::GetObject(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    WCHAR * _arg0;
    WCHAR * _arg1;
...
}
{
  _arg2 = &temp;
	...
	IADsContainer *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,"OO:GetObject",&_obj0,&_obj1)) 
        return NULL;
{
	// Wide string code!
...
{
	Py_BEGIN_ALLOW_THREADS
	    _result = (HRESULT )_swig_self->GetObject(_arg0,_arg1,_arg2);
...
{
	MAKE_OUTPUT_INTERFACE(_arg2, _resultobj, IID_IDispatch)
}
{
	// Wide string cleanup
	PyWinObject_FreeWCHAR(_arg0);
...
PyObject *PyIADsContainer::get_Count(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    long * _arg0;
    long  temp;

{
  _arg0 = &temp;
	...
	IADsContainer *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,":get_Count")) 
        return NULL;
{
	Py_BEGIN_ALLOW_THREADS
	    _result = (HRESULT )_swig_self->get_Count(_arg0);
...
PyObject *PyIADsContainer::get_Filter(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    VARIANT * _arg0;
    VARIANT  temp;

{
  _arg0 = &temp;
	...
	IADsContainer *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,":get_Filter")) 
        return NULL;
{
	Py_BEGIN_ALLOW_THREADS
	    _result = (HRESULT )_swig_self->get_Filter(_arg0);
...
{
    PyObject *o;
    o = PyCom_PyObjectFromVariant(_arg0);
    if (!_resultobj) {
      _resultobj = o;
    } else if (_resultobj == Py_None) {
      Py_DECREF(Py_None);
...
PyObject *PyIADsContainer::get_Hints(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    VARIANT * _arg0;
    VARIANT  temp;

{
  _arg0 = &temp;
	...
	IADsContainer *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,":get_Hints")) 
        return NULL;
{
	Py_BEGIN_ALLOW_THREADS
	    _result = (HRESULT )_swig_self->get_Hints(_arg0);
...
static PyMethodDef IADsContainerMethods[] = {
	 { "put_Hints", PyIADsContainer::put_Hints, 1 },
	 { "get_Hints", PyIADsContainer::get_Hints, 1 },
	 { "put_Filter", PyIADsContainer::put_Filter, 1 },
	 { "get_Filter", PyIADsContainer::get_Filter, 1 },
	 { "get_Count", PyIADsContainer::get_Count, 1 },
	 { "GetObject", PyIADsContainer::GetObject, 1 },
	 { NULL, NULL }
};
PyComTypeObject PyIADsContainer::type("PyIADsContainer",	&PyIDispatch::type,
	sizeof(PyIADsContainer),
	IADsContainerMethods,
	GET_PYCOM_CTOR(PyIADsContainer));

/*
 * FILE : O:\src\pywin32\com\win32comext\adsi\src\PyIADsDeleteOps.cpp
 * 
...
PyObject *PyIADsDeleteOps::DeleteObject(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    LONG  _arg0 = 0;

	IADsDeleteOps *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,"|l:DeleteObject",&_arg0)) 
        return NULL;
{
	Py_BEGIN_ALLOW_THREADS
	    _result = (HRESULT )_swig_self->DeleteObject(_arg0);
...
static PyMethodDef IADsDeleteOpsMethods[] = {
	 { "DeleteObject", PyIADsDeleteOps::DeleteObject, 1 },
	 { NULL, NULL }
};
PyComTypeObject PyIADsDeleteOps::type("PyIADsDeleteOps",	&PyIDispatch::type,
	sizeof(PyIADsDeleteOps),
	IADsDeleteOpsMethods,
	GET_PYCOM_CTOR(PyIADsDeleteOps));

/*
 * FILE : O:\src\pywin32\com\win32comext\adsi\src\PyIDsObjectPicker.cpp
 * 
...
PyObject *PyIDsObjectPicker::InvokeDialog(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    HWND  _arg0;
    IDataObject ** _arg1;
...

{
  _arg1 = &temp;
	...
	IDsObjectPicker *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,"O:InvokeDialog",&_obj0)) 
        return NULL;
{
...
{
	Py_BEGIN_ALLOW_THREADS
	    _result = (HRESULT )_swig_self->InvokeDialog(_arg0,_arg1);
...
{
	MAKE_OUTPUT_INTERFACE(_arg1, _resultobj, IID_IDataObject)
}
    return _resultobj;
}

static PyMethodDef IDsObjectPickerMethods[] = {
	 { "InvokeDialog", PyIDsObjectPicker::InvokeDialog, 1 },
	 { "Initialize", PyIDsObjectPicker::Initialize, 1 },
	 { NULL, NULL }
};
PyComTypeObject PyIDsObjectPicker::type("PyIDsObjectPicker",	&PyIUnknown::type,
	sizeof(PyIDsObjectPicker),
	IDsObjectPickerMethods,
	GET_PYCOM_CTOR(PyIDsObjectPicker));

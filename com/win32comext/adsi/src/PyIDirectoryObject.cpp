/*
 * FILE : O:\src\pywin32\com\win32comext\adsi\src\PyIDirectoryObject.cpp
 * 
...
PyObject *PyIDirectoryObject::GetObjectInformation(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    ADS_OBJECT_INFO ** _arg0;
    ADS_OBJECT_INFO * temp;

{
	...
	*_arg0 = NULL;
	...
	IDirectoryObject *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,":GetObjectInformation")) 
        return NULL;
{
	Py_BEGIN_ALLOW_THREADS
	    _result = (HRESULT )_swig_self->GetObjectInformation(_arg0);

	Py_END_ALLOW_THREADS
	if (FAILED(_result))  {
		{
	if (*_arg0) FreeADsMem(*_arg0);
}
...
{
	PyObject *o;
	o = PyADSIObject_FromADS_OBJECT_INFO(*_arg0);
	if (!_resultobj) {
		_resultobj = o;
...
PyObject *PyIDirectoryObject::DeleteDSObject(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    WCHAR * _arg0;
    PyObject * _obj0 = 0;

{
	...
	IDirectoryObject *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,"O:DeleteDSObject",&_obj0)) 
        return NULL;
{
	// Wide string code!
...
{
	Py_BEGIN_ALLOW_THREADS
	    _result = (HRESULT )_swig_self->DeleteDSObject(_arg0);
...
static PyMethodDef IDirectoryObjectMethods[] = {
	 { "DeleteDSObject", PyIDirectoryObject::DeleteDSObject, 1 },
	 { "CreateDSObject", PyIDirectoryObject::CreateDSObject, 1 },
	 { "SetObjectAttributes", PyIDirectoryObject::SetObjectAttributes, 1 },
	 { "GetObjectAttributes", PyIDirectoryObject::GetObjectAttributes, 1 },
	 { "GetObjectInformation", PyIDirectoryObject::GetObjectInformation, 1 },
	 { NULL, NULL }
};
PyComTypeObject PyIDirectoryObject::type("PyIDirectoryObject",	&PyIUnknown::type,
	sizeof(PyIDirectoryObject),
	IDirectoryObjectMethods,
	GET_PYCOM_CTOR(PyIDirectoryObject));

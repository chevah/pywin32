...
PyIPropertyStoreCache::PyIPropertyStoreCache(IUnknown *pdisp):
	PyIPropertyStore(pdisp)
{
	ob_type = &type;
}
...
// @pymethod (<o PyPROPVARIANT>, int)|PyIPropertyStoreCache|GetValueAndState|Retrieves the current value and state of a property
...
PyObject *PyIPropertyStoreCache::SetValueAndState(PyObject *self, PyObject *args)
{
	...
	PROPERTYKEY key;
	PROPVARIANT *pval;
	if ( !PyArg_ParseTuple(args, "O&O&i:SetValueAndState",
		PyWinObject_AsPROPERTYKEY, &key,
		PyWinObject_AsPROPVARIANT, &pval,
		&state))
		return NULL;
...
// @object PyIPropertyStoreCache|Property store that allows tracking of modification state.  Inherits all methods of <o PyIPropertyStore>.
static struct PyMethodDef PyIPropertyStoreCache_methods[] =
{
	...
	{ "GetValueAndState", PyIPropertyStoreCache::GetValueAndState, 1 }, // @pymeth GetValueAndState|Retrieves the current value and state of a property
	{ "SetState", PyIPropertyStoreCache::SetState, 1 }, // @pymeth SetState|Sets the state of a property
	{ "SetValueAndState", PyIPropertyStoreCache::SetValueAndState, 1 }, // @pymeth SetValueAndState|Sets the value and state of a property
	{ NULL }
};

PyComTypeObject PyIPropertyStoreCache::type("PyIPropertyStoreCache",
		&PyIPropertyStore::type,
		sizeof(PyIPropertyStoreCache),
		PyIPropertyStoreCache_methods,

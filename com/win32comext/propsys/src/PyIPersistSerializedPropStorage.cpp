...
PyIPersistSerializedPropStorage::PyIPersistSerializedPropStorage(IUnknown *pdisp):
	PyIUnknown(pdisp)
{
	ob_type = &type;
}
...
// @pymethod buffer|PyIPersistSerializedPropStorage|GetPropertyStorage|Retrieves the current contents of the property store

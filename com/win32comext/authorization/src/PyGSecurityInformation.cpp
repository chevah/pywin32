...
// @pymethod <o PySECURITY_DESCRIPTOR>|PyGSecurityInformation|GetSecurity|Retrieves the object's current security settings
// @pyparm int|RequestedInformation||Combination of SECURITY_INFORMATION flags indicating which components of the object's security descriptor you should return
// @pyparm bool|Default||If true, return a default security descriptor rather than current security.  (invoked when 'Reset' button is clicked)
STDMETHODIMP PyGSecurityInformation::GetSecurity(
...
// @pyparm int|SecurityInformation||SECURITY_INFORMATION flags specifying which types of security information are to be applied
...
STDMETHODIMP PyGSecurityInformation::SetSecurity(
...
// @pyparm int|Flags||Indicates which page is requesting the access rights (SI_ADVANCED, SI_EDIT_AUDITS, SI_EDIT_PROPERTIES)
...
STDMETHODIMP PyGSecurityInformation::MapGeneric(
...
// @tupleitem 1|int|Flags|ACE inheritance flags, combination of OBJECT_INHERIT_ACE, CONTAINER_INHERIT_ACE, INHERIT_ONLY_ACE
// @tupleitem 2|<o PyUNICODE>|Name|Description that will be displayed on the Advanced page

// @pymethod (<o SI_INHERIT_TYPE>,...)|PyGSecurityInformation|GetInheritTypes|Requests types of inheritance that your implementation supports
// @rdesc Returns a sequence of <o SI_INHERIT_TYPE> tuples
STDMETHODIMP PyGSecurityInformation::GetInheritTypes(
...
STDMETHODIMP PyGSecurityInformation::PropertySheetPageCallback(
	HWND hwnd,
	UINT uMsg,
	SI_PAGE_TYPE uPage)

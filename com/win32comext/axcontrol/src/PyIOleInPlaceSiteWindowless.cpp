...
{
	{ "CanWindowlessActivate", PyIOleInPlaceSiteWindowless::CanWindowlessActivate, 1 }, // @pymeth CanWindowlessActivate|Description of CanWindowlessActivate
	...
	{ "InvalidateRect", PyIOleInPlaceSiteWindowless::InvalidateRect, 1 }, // @pymeth InvalidateRect|Description of InvalidateRect
	{ "InvalidateRgn", PyIOleInPlaceSiteWindowless::InvalidateRgn, 1 }, // @pymeth InvalidateRgn|Description of InvalidateRgn
	...
	{ "OnDefWindowMessage", PyIOleInPlaceSiteWindowless::OnDefWindowMessage, 1 }, // @pymeth OnDefWindowMessage|Description of OnDefWindowMessage
	{ NULL }
};

PyComTypeObject PyIOleInPlaceSiteWindowless::type("PyIOleInPlaceSiteWindowless",
		&PyIOleInPlaceSiteEx::type,
...
STDMETHODIMP PyGOleInPlaceSiteWindowless::CanWindowlessActivate(
		void)
{
	PY_GATEWAY_METHOD;
...
STDMETHODIMP PyGOleInPlaceSiteWindowless::GetCapture(
		void)
{
	PY_GATEWAY_METHOD;
...
STDMETHODIMP PyGOleInPlaceSiteWindowless::GetFocus(
		void)
{
	PY_GATEWAY_METHOD;
...
{
	PY_GATEWAY_METHOD;
	HRESULT hr=InvokeViaPolicy("InvalidateRect", NULL, "(llll)i", pRect->left, pRect->top, pRect->right, pRect->bottom, fErase);
	return hr;
}

...
static struct PyMethodDef PyIScheduledWorkItem_methods[] =
{
	...
	{ "GetCreator", PyIScheduledWorkItem::GetCreator, 1 }, // @pymeth GetCreator|Returns creator info, can be any string data
	{ "SetWorkItemData", PyIScheduledWorkItem::SetWorkItemData, 1 }, // @pymeth SetWorkItemData|Set data associated with task (treated as uninterpreted bytes)
	{ "GetWorkItemData", PyIScheduledWorkItem::GetWorkItemData, 1 }, // @pymeth GetWorkItemData|Retrieve data associated with task
	{ "SetErrorRetryCount", PyIScheduledWorkItem::SetErrorRetryCount, 1 }, // @pymeth SetErrorRetryCount|Specify nbr of times to attempt to run task if it can't start (not currently implemented)
	{ "GetErrorRetryCount", PyIScheduledWorkItem::GetErrorRetryCount, 1 }, // @pymeth GetErrorRetryCount|Return nbr of times Task scheduler should try to run task (not currently implemented)
	{ "SetErrorRetryInterval", PyIScheduledWorkItem::SetErrorRetryInterval, 1 }, // @pymeth SetErrorRetryInterval|Interval in minutes between attempts to run task. Not implemented according to SDK
	{ "GetErrorRetryInterval", PyIScheduledWorkItem::GetErrorRetryInterval, 1 }, // @pymeth GetErrorRetryInterval|Returns nbr of minutes between attempts to run task. Not implemented according to SDK
	...
	{ "SetAccountInformation", PyIScheduledWorkItem::SetAccountInformation, 1 }, // @pymeth SetAccountInformation|Set username and password under which task will run
	{ "GetAccountInformation", PyIScheduledWorkItem::GetAccountInformation, 1 }, // @pymeth GetAccountInformation|Returns username that task will run under
	{ NULL }
};

PyComTypeObject PyIScheduledWorkItem::type("PyIScheduledWorkItem",
		&PyIUnknown::type,
		sizeof(PyIScheduledWorkItem),
		PyIScheduledWorkItem_methods,
		GET_PYCOM_CTOR(PyIScheduledWorkItem));

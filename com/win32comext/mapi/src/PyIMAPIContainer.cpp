/*
 * FILE : O:\src\pywin32\com\win32comext\mapi\src\PyIMAPIContainer.cpp
 * 
...
PyObject *PyIMAPIContainer::GetContentsTable(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    unsigned long  _arg0;
    IMAPITable ** _arg1;
...

{
  _arg1 = &temp;
	...
	IMAPIContainer *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,"l:GetContentsTable",&_arg0)) 
        return NULL;
{
      Py_BEGIN_ALLOW_THREADS
          _result = (HRESULT )_swig_self->GetContentsTable(_arg0,_arg1);
...
PyObject *PyIMAPIContainer::GetHierarchyTable(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    unsigned long  _arg0;
    IMAPITable ** _arg1;
...

{
  _arg1 = &temp;
	...
	IMAPIContainer *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,"l:GetHierarchyTable",&_arg0)) 
        return NULL;
{
      Py_BEGIN_ALLOW_THREADS
          _result = (HRESULT )_swig_self->GetHierarchyTable(_arg0,_arg1);
...
static PyMethodDef IMAPIContainerMethods[] = {
	 { "OpenEntry", PyIMAPIContainer::OpenEntry, 1 },
	 { "GetHierarchyTable", PyIMAPIContainer::GetHierarchyTable, 1 },
	 { "GetContentsTable", PyIMAPIContainer::GetContentsTable, 1 },
	 { NULL, NULL }
};
PyComTypeObject PyIMAPIContainer::type("PyIMAPIContainer",	&PyIMAPIProp::type,
	sizeof(PyIMAPIContainer),
	IMAPIContainerMethods,
	GET_PYCOM_CTOR(PyIMAPIContainer));

/*
 * FILE : O:\src\pywin32\com\win32comext\mapi\src\PyIAddrBook.cpp
 * 
...
PyObject *PyIAddrBook::ResolveName(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    unsigned long  _arg0;
    ULONG  _arg1;
...

{
	...
	IAddrBook *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,"llOO:ResolveName",&_arg0,&_arg1,&_obj2,&_obj3)) 
        return NULL;
{
...
{
	if (!PyMAPIObject_AsADRLIST(_obj3, &_arg3, FALSE))
		return NULL;
}
{
      Py_BEGIN_ALLOW_THREADS
          _result = (HRESULT )_swig_self->ResolveName(_arg0,_arg1,_arg2,_arg3);
...
{
	if (_arg3) PyMAPIObject_FreeADRLIST(_arg3);
}
...
{
	PyObject *o;
	o = PyMAPIObject_FromADRLIST(_arg3);
	if (!_resultobj) {
		_resultobj = o;
...
static PyMethodDef IAddrBookMethods[] = {
	 { "CompareEntryIDs", PyIAddrBook::CompareEntryIDs, 1 },
	 { "OpenEntry", PyIAddrBook::OpenEntry, 1 },
	 { "ResolveName", PyIAddrBook::ResolveName, 1 },
	 { NULL, NULL }
};
PyComTypeObject PyIAddrBook::type("PyIAddrBook",	&PyIMAPIProp::type,
	sizeof(PyIAddrBook),
	IAddrBookMethods,
	GET_PYCOM_CTOR(PyIAddrBook));

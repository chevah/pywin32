/*
 * FILE : O:\src\pywin32\com\win32comext\mapi\src\PyIConverterSession.cpp
 * 
...
static PyMethodDef IConverterSessionMethods[] = {
	 { "SetAdrBook", PyIConverterSession::SetAdrBook, 1 },
	 { "MAPIToMIMEStm", PyIConverterSession::MAPIToMIMEStm, 1 },
	 { "MIMEToMAPI", PyIConverterSession::MIMEToMAPI, 1 },
	 { NULL, NULL }
};
PyComTypeObject PyIConverterSession::type("PyIConverterSession",	&PyIUnknown::type,
	sizeof(PyIConverterSession),
	IConverterSessionMethods,
	GET_PYCOM_CTOR(PyIConverterSession));

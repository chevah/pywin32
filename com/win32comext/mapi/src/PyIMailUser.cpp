/*
 * FILE : O:\src\pywin32\com\win32comext\mapi\src\PyIMailUser.cpp
 * 
...
static PyMethodDef IMailUserMethods[] = {
	 { NULL, NULL }
};
PyComTypeObject PyIMailUser::type("PyIMailUser",	&PyIMAPIContainer::type,
	sizeof(PyIMailUser),
	IMailUserMethods,
	GET_PYCOM_CTOR(PyIMailUser));

/*
 * FILE : O:\src\pywin32\com\win32comext\mapi\src\PyIMAPISession.cpp
 * 
...
PyObject *PyIMAPISession::Unadvise(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    unsigned long  _arg0;
...
PyObject *PyIMAPISession::GetMsgStoresTable(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    unsigned long  _arg0;
    IMAPITable ** _arg1;
...

{
  _arg1 = &temp;
	...
	IMAPISession *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,"l:GetMsgStoresTable",&_arg0)) 
        return NULL;
{
      Py_BEGIN_ALLOW_THREADS
          _result = (HRESULT )_swig_self->GetMsgStoresTable(_arg0,_arg1);
...
PyObject *PyIMAPISession::GetStatusTable(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    unsigned long  _arg0;
    IMAPITable ** _arg1;
...

{
  _arg1 = &temp;
	...
	IMAPISession *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,"l:GetStatusTable",&_arg0)) 
        return NULL;
{
      Py_BEGIN_ALLOW_THREADS
          _result = (HRESULT )_swig_self->GetStatusTable(_arg0,_arg1);
...
PyObject *PyIMAPISession::Logoff(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    unsigned long  _arg0;
    unsigned long  _arg1;
	...
	IMAPISession *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,"lll:Logoff",&_arg0,&_arg1,&_arg2)) 
        return NULL;
{
      Py_BEGIN_ALLOW_THREADS
          _result = (HRESULT )_swig_self->Logoff(_arg0,_arg1,_arg2);
...
PyObject *PyIMAPISession::OpenAddressBook(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    unsigned long  _arg0;
    IID * _arg1;
...

{
  _arg3 = &temp;
	...
	IMAPISession *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,"lOl:OpenAddressBook",&_arg0,&_obj1,&_arg2)) 
        return NULL;
{
	if (_obj1==Py_None)
		_arg1 = NULL;
...
{
      Py_BEGIN_ALLOW_THREADS
          _result = (HRESULT )_swig_self->OpenAddressBook(_arg0,_arg1,_arg2,_arg3);
...
{
	MAKE_OUTPUT_INTERFACE(_arg3, _resultobj, IID_IAddrBook)
}
    return _resultobj;
}

PyObject *PyIMAPISession::OpenProfileSection(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    MAPIUID * _arg0;
    IID * _arg1;
...
static PyMethodDef IMAPISessionMethods[] = {
	 { "OpenProfileSection", PyIMAPISession::OpenProfileSection, 1 },
	 { "OpenAddressBook", PyIMAPISession::OpenAddressBook, 1 },
	 { "Logoff", PyIMAPISession::Logoff, 1 },
	 { "GetStatusTable", PyIMAPISession::GetStatusTable, 1 },
	 { "GetMsgStoresTable", PyIMAPISession::GetMsgStoresTable, 1 },
	 { "GetLastError", PyIMAPISession::GetLastError, 1 },
	 { "CompareEntryIDs", PyIMAPISession::CompareEntryIDs, 1 },
	 { "Unadvise", PyIMAPISession::Unadvise, 1 },
	 { "Advise", PyIMAPISession::Advise, 1 },
	 { "QueryIdentity", PyIMAPISession::QueryIdentity, 1 },
	 { "OpenMsgStore", PyIMAPISession::OpenMsgStore, 1 },
	 { "OpenEntry", PyIMAPISession::OpenEntry, 1 },
	 { NULL, NULL }
};
PyComTypeObject PyIMAPISession::type("PyIMAPISession",	&PyIUnknown::type,
	sizeof(PyIMAPISession),
	IMAPISessionMethods,
	GET_PYCOM_CTOR(PyIMAPISession));

...
/* static */ IObjectSafety *PyIObjectSafety::GetI(PyObject *self)
{
	return (IObjectSafety *)PyIUnknown::GetI(self);
}
...
/* static */ PyObject *PyIObjectSafety::GetInterfaceSafetyOptions(PyObject *self, PyObject *args)
{
	...
	HRESULT hr = pIOS->GetInterfaceSafetyOptions(iid,
												 &dwSupportedOptions,
												 &dwEnabledOptions);
...
/* static */ PyObject *PyIObjectSafety::SetInterfaceSafetyOptions(PyObject *self, PyObject *args)
{
	...
	int optionSetMask;
	int enabledOptions;
	if ( !PyArg_ParseTuple(args, "Oii:SetInterfaceSafetyOptions",
						   &obiid, &optionSetMask, &enabledOptions) )
		return NULL;
...
PyComTypeObject PyIObjectSafety::type("PyIObjectSafety",
		&PyIUnknown::type,
		sizeof(PyIObjectSafety),
		PyIObjectSafety_methods,
		GET_PYCOM_CTOR(PyIObjectSafety));

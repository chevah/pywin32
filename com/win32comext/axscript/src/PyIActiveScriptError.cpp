...
{
	{ "GetExceptionInfo", PyIActiveScriptError::GetExceptionInfo, 1 }, // @pymeth GetExceptionInfo|Description of GetExceptionInfo
	{ "GetSourcePosition", PyIActiveScriptError::GetSourcePosition, 1 }, // @pymeth GetSourcePosition|Description of GetSourcePosition
	{ "GetSourceLineText", PyIActiveScriptError::GetSourceLineText, 1 }, // @pymeth GetSourceLineText|Description of GetSourceLineText
	{ NULL }
};

PyComTypeObject PyIActiveScriptError::type("PyIActiveScriptError",
		&PyIUnknown::type,
		sizeof(PyIActiveScriptError),
		PyIActiveScriptError_methods,
		GET_PYCOM_CTOR(PyIActiveScriptError));

...
{
	{ "ParseProcedureText", PyIActiveScriptParseProcedure::ParseProcedureText, 1 }, // @pymeth ParseProcedureText|Description of ParseProcedureText
	{ NULL }
};

PyComTypeObject PyIActiveScriptParseProcedure::type("PyIActiveScriptParseProcedure",
		&PyIUnknown::type,
		...
		/* [out] */ IDispatch __RPC_FAR *__RPC_FAR * ppdisp)
{
	...
	PyObject *obppdisp;
	if (!PyArg_Parse(result, "O" , &obppdisp)) return PyCom_HandlePythonFailureToCOM(/*pexcepinfo*/);
	BOOL bPythonIsHappy = TRUE;

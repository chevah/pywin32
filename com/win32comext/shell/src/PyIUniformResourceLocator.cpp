...
static struct PyMethodDef PyIUniformResourceLocator_methods[] =
{
	...
	{ "InvokeCommand", PyIUniformResourceLocator::InvokeCommand, METH_VARARGS, "Performs one of the object's predefined actions" },
	{ NULL }
};

PyComTypeObject PyIUniformResourceLocator::type("PyIUniformResourceLocator",
		&PyIUnknown::type,
		sizeof(PyIUniformResourceLocator),
		PyIUniformResourceLocator_methods,

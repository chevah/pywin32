...
PyIApplicationDocumentLists::PyIApplicationDocumentLists(IUnknown *pdisp):
	PyIUnknown(pdisp)
{
	ob_type = &type;
}
...
PyObject *PyIApplicationDocumentLists::GetList(PyObject *self, PyObject *args)
{
	...
	if ( !PyArg_ParseTuple(args, "i|kO&:GetList", &listtype, &cItemsDesired,
...
{
	{ "SetAppID", PyIApplicationDocumentLists::SetAppID, 1 }, // @pymeth SetAppID|Specifies the application whose jump list is to be accessed
	{ "GetList", PyIApplicationDocumentLists::GetList, 1 }, // @pymeth GetList|Retrieves a list of items in a jump list
	{ NULL }
};

PyComTypeObject PyIApplicationDocumentLists::type("PyIApplicationDocumentLists",
		&PyIUnknown::type,

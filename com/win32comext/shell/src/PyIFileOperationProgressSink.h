...
protected:
	...
	PYGATEWAY_MAKE_SUPPORT2(PyGFileOperationProgressSink, IFileOperationProgressSink, IID_IFileOperationProgressSink, PyGatewayBase)

	// IFileOperationProgressSink
	// @pymeth StartOperations|Called as operation begins, before any modifications are done
	STDMETHOD(StartOperations)(
		void);

...
/* static */ IInputObject *PyIInputObject::GetI(PyObject *self)
{
	return (IInputObject *)PyIOleWindow::GetI(self);
}
...
{
	{ "TranslateAcceleratorIO", PyIInputObject::TranslateAcceleratorIO, 1 }, // @pymeth TranslateAccelerator|Description of TranslateAccelerator
...
PyComTypeObject PyIInputObject::type("PyIInputObject",
		&PyIOleWindow::type,
		sizeof(PyIInputObject),
		PyIInputObject_methods,
		GET_PYCOM_CTOR(PyIInputObject));
// ---------------------------------------------------
//
		...
		/* [in] */ MSG * pmsg)
{
	...
	if (obpmsg==NULL) return MAKE_PYCOM_GATEWAY_FAILURE_CODE("TranslateAcceleratorIO");
	PyObject *result;
		...
		/* [in] */ MSG * pmsg)
{
	PY_GATEWAY_METHOD;
	PyObject *obpmsg = PyObject_FromMSG(pmsg);
	if (obpmsg==NULL) return MAKE_PYCOM_GATEWAY_FAILURE_CODE("UIActivateIO");
	HRESULT hr=InvokeViaPolicy("UIActivateIO", NULL, "iN", uState, obpmsg);
	return hr;
}

STDMETHODIMP PyGInputObject::HasFocusIO(
		void)
{
	PY_GATEWAY_METHOD;
	PyObject *result;

...
PyIRelatedItem::PyIRelatedItem(IUnknown *pdisp):
	PyIUnknown(pdisp)
{
	ob_type = &type;
}
...
/* static */ IRelatedItem *PyIRelatedItem::GetI(PyObject *self)
{
	return (IRelatedItem *)PyIUnknown::GetI(self);
}
...
{
	{ "GetItemIDList", PyIRelatedItem::GetItemIDList, 1 }, // @pymeth GetItemIDList|Returns the ID list of the related item
	{ "GetItem", PyIRelatedItem::GetItem, 1 }, // @pymeth GetItem|Returns the related item
	{ NULL }
};

PyComTypeObject PyIRelatedItem::type("PyIRelatedItem",
		&PyIUnknown::type,
		sizeof(PyIRelatedItem),
		PyIRelatedItem_methods,
		GET_PYCOM_CTOR(PyIRelatedItem));
// ---------------------------------------------------
//

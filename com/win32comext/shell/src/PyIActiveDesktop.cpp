...
{
	return Py_BuildValue("{s:k,s:i,s:i,s:k,s:k,s:i,s:O&,s:O&,s:O&,s:i,s:i}",
		"Size",		comppos->dwSize,
		"Left",		comppos->iLeft,
		"Top",		comppos->iTop,
		"Width",		comppos->dwWidth,
		"Height",		comppos->dwHeight,
		"zIndex",		comppos->izIndex,
		"CanResize",	PyBool_FromLong, comppos->fCanResize,
		"CanResizeX",	PyBool_FromLong, comppos->fCanResizeX,
		"CanResizeY",	PyBool_FromLong, comppos->fCanResizeY,
		"PreferredLeftPercent",	comppos->iPreferredLeftPercent,
		"PreferredTopPercent",	comppos->iPreferredTopPercent);
}

BOOL PyWinObject_AsCOMPPOS(PyObject *ob, COMPPOS *comppos)
{
	static char *COMPPOS_keywords[]={"Left","Top","Width","Height","zIndex",
		"CanResize","CanResizeX","CanResizeY","PreferredLeftPercent",
		"PreferredTopPercent", "Size", NULL};
	...
	BOOL bsuccess=PyArg_ParseTupleAndKeywords(dummy_args, ob, "iikkiiiiii|k:COMPPOS", COMPPOS_keywords,
...
{
	return Py_BuildValue("{s:k,s:i,s:i,s:k,s:k,s:k}",
		"Size",		compstateinfo->dwSize,
		"Left",		compstateinfo->iLeft,
		"Top",		compstateinfo->iTop,
		"Width",	compstateinfo->dwWidth,
		"Height",	compstateinfo->dwHeight,
...
BOOL PyWinObject_AsCOMPSTATEINFO(PyObject *ob, COMPSTATEINFO *compstateinfo)
{
	...
	BOOL bsuccess=PyArg_ParseTupleAndKeywords(dummy_args, ob, "iikkk|k:COMPSTATEINFO", COMPSTATEINFO_keywords,
...
{
	return Py_BuildValue("{s:k,s:k,s:i,s:O&,s:O&,s:O&,s:O&,s:u,s:u,s:u,s:k,s:O&,s:O&}",
		"Size",			component->dwSize,
		"ID",			component->dwID,
		"ComponentType",component->iComponentType,
		"Checked",		PyBool_FromLong,	component->fChecked,
		"Dirty",		PyBool_FromLong,	component->fDirty,
		"NoScroll",		PyBool_FromLong,	component->fNoScroll,
		"Pos",			PyWinObject_FromCOMPPOS, &component->cpPos,
		"FriendlyName", component->wszFriendlyName,
		"Source",		component->wszSource,
		"SubscribedURL",component->wszSubscribedURL,
		"CurItemState",	component->dwCurItemState,
		"Original",		PyWinObject_FromCOMPSTATEINFO,	&component->csiOriginal,
		"Restored",		PyWinObject_FromCOMPSTATEINFO,	&component->csiRestored);
}

BOOL PyWinObject_AsCOMPONENT(PyObject *ob, COMPONENT *component)
{
	static char *COMPONENT_keywords[]={"ID","ComponentType","Checked","Dirty","NoScroll",
		"Pos","FriendlyName","Source","SubscribedURL","CurItemState",
		"Original","Restored","Size", NULL};
	...
	bool bsuccess=PyArg_ParseTupleAndKeywords(dummy_args, ob, "kiiiiO&OOOkO&O&|k:COMPONENT", COMPONENT_keywords,
		...
		&& PyWinObject_AsWCHAR(obFriendlyName, &FriendlyName, FALSE)
...
{
	return Py_BuildValue("{s:k,s:O&,s:O&}",
		"Size",		componentsopt->dwSize,
		"EnableComponents",	PyBool_FromLong,	componentsopt->fEnableComponents,
		"ActiveDesktop",	PyBool_FromLong,	componentsopt->fActiveDesktop);
}
...
BOOL PyWinObject_AsCOMPONENTSOPT(PyObject *ob, COMPONENTSOPT *componentsopt)
{
	...
	BOOL bsuccess=PyArg_ParseTupleAndKeywords(dummy_args, ob, "kk|k:COMPONENTSOPT", COMPONENTSOPT_keywords,
...
IActiveDesktop *PyIActiveDesktop::GetI(PyObject *self)
{
	return (IActiveDesktop *)PyIUnknown::GetI(self);
}
...
PyObject *PyIActiveDesktop::SetPattern(PyObject *self, PyObject *args)
{
	...
	WCHAR *Pattern=NULL;
	DWORD reserved=0;
	if ( !PyArg_ParseTuple(args, "O|k:SetPattern",
...
static struct PyMethodDef PyIActiveDesktop_methods[] =
{
	...
	{ "ApplyChanges", PyIActiveDesktop::ApplyChanges, METH_VARARGS, "Applies changes to ActiveDesktop settings and persists them to the registry"},
	...
	{ "GetDesktopItemOptions", PyIActiveDesktop::GetDesktopItemOptions, METH_VARARGS, "Returns options for Active Desktop."},
	...
	{ "GetDesktopItemCount", PyIActiveDesktop::GetDesktopItemCount, METH_VARARGS, "Returns number of defined desktop items."},
	...
	{ "GenerateDesktopItemHtml", PyIActiveDesktop::GenerateDesktopItemHtml, METH_VARARGS, "Creates an HTML page for the desktop item"},
	...
	{ "GetDesktopItemBySource", PyIActiveDesktop::GetDesktopItemBySource, METH_VARARGS, "Returns desktop item parameters by URL"},
	{ NULL }
};

PyComTypeObject PyIActiveDesktop::type("PyIActiveDesktop",
		&PyIUnknown::type,
		sizeof(PyIActiveDesktop),
		PyIActiveDesktop_methods,
		GET_PYCOM_CTOR(PyIActiveDesktop));
...
IActiveDesktopP *PyIActiveDesktopP::GetI(PyObject *self)
{
	return (IActiveDesktopP *)PyIUnknown::GetI(self);
}
...
PyComTypeObject PyIActiveDesktopP::type("PyIActiveDesktopP",
		&PyIUnknown::type,
		sizeof(PyIActiveDesktopP),
		PyIActiveDesktopP_methods,
		GET_PYCOM_CTOR(PyIActiveDesktopP));
...
IADesktopP2 *PyIADesktopP2::GetI(PyObject *self)
{
	return (IADesktopP2 *)PyIUnknown::GetI(self);
}
...
static struct PyMethodDef PyIADesktopP2_methods[] =
{
	...
	{ "UpdateAllDesktopSubscriptions", PyIADesktopP2::UpdateAllDesktopSubscriptions, METH_VARARGS, "Updates webpage subscriptions on the desktop"},
	{ NULL }
};

PyComTypeObject PyIADesktopP2::type("PyIADesktopP2",
		&PyIUnknown::type,
		sizeof(PyIADesktopP2),
		PyIADesktopP2_methods,

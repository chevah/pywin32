...
PyIServerSecurity::PyIServerSecurity(IUnknown *pdisp):
	PyIUnknown(pdisp)
{
	ob_type = &type;
}
...
{
	{ "QueryBlanket", PyIServerSecurity::QueryBlanket, 1 }, // @pymeth QueryBlanket|Retrieves security settings specified by the client
	{ "ImpersonateClient", PyIServerSecurity::ImpersonateClient, METH_NOARGS}, // @pymeth ImpersonateClient|Initiates impersonation of client
	{ "RevertToSelf", PyIServerSecurity::RevertToSelf, METH_NOARGS}, // @pymeth RevertToSelf|Ends impersonation of client
	{ "IsImpersonating", PyIServerSecurity::IsImpersonating, METH_NOARGS}, // @pymeth IsImpersonating|Determines if server is currently impersonating a client
	{ NULL }
};

PyComTypeObject PyIServerSecurity::type("PyIServerSecurity",
		&PyIUnknown::type,
		sizeof(PyIServerSecurity),
		PyIServerSecurity_methods,
		GET_PYCOM_CTOR(PyIServerSecurity));
// ---------------------------------------------------
//

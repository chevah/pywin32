...
/* static */ IEnumString *PyIEnumString::GetI(PyObject *self)
{
	return (IEnumString *)PyIUnknown::GetI(self);
}
...
// @pymethod <o PyIEnumString>|PyIEnumString|Clone|Creates another enumerator that contains the same enumeration state as the current one
...
{
	{ "Next", PyIEnumString::Next, METH_VARARGS },		// @pymeth Next|Retrieves a specified number of items in the enumeration sequence.
	...
	{ "Clone", PyIEnumString::Clone, METH_VARARGS },	// @pymeth Clone|Creates another enumerator that contains the same enumeration state as the current one.
	{ NULL }
};

PyComEnumTypeObject PyIEnumString::type("PyIEnumString",
		&PyIUnknown::type, // @base PyIEnumString|PyIUnknown
		sizeof(PyIEnumString),
		PyIEnumString_methods,
		GET_PYCOM_CTOR(PyIEnumString));

...
// @pymethod <o PyIEnumConnectionPoints>|PyIConnectionPointContainer|EnumConnectionPoints|Creates an enumerator object to iterate through all the connection points supported in the connectable object, one connection point per outgoing IID.
...
// @pymethod <o PyIConnectionPoint>|PyIConnectionPointContainer|FindConnectionPoint|Finds a connection point for the given IID
...
{
	{ "EnumConnectionPoints", PyIConnectionPointContainer::EnumConnectionPoints, 1 }, // @pymeth EnumConnectionPoints|Creates an enumerator object to iterate through all the connection points supported in the connectable object, one connection point per outgoing IID.
	{ "FindConnectionPoint", PyIConnectionPointContainer::FindConnectionPoint, 1 }, // @pymeth FindConnectionPoint|Finds a connection point for the given IID.
	{ NULL }
};

...
/* static */ ICreateTypeLib *PyICreateTypeLib::GetI(PyObject *self)
{
	return (ICreateTypeLib *)PyIUnknown::GetI(self);
}
...
static struct PyMethodDef PyICreateTypeLib_methods[] =
{
	...
	{ "SetHelpFileName", PyICreateTypeLib::SetHelpFileName, 1 }, // @pymeth SetHelpFileName|Description of SetHelpFileName
...
PyComTypeObject PyICreateTypeLib::type("PyICreateTypeLib",
		&PyIUnknown::type,
		sizeof(PyICreateTypeLib),
		PyICreateTypeLib_methods,
		GET_PYCOM_CTOR(PyICreateTypeLib));

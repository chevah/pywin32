...
// @pymethod |PyICatRegister|RegisterClassImplCategories|Registers the class as implementing one or more component categories.
...
// @pymethod |PyICatRegister|UnRegisterClassImplCategories|Unregisters the class as implementing one or more component categories.
...
// @pymethod |PyICatRegister|RegisterClassReqCategories|Registers the class as requiring one or more component categories.
...
{
	{ "RegisterCategories", PyICatRegister::RegisterCategories, 1 }, // @pymeth RegisterCategories|Registers one or more component categories. Each component category consists of a CATID and a list of locale-dependent description strings.
	{ "UnRegisterCategories", PyICatRegister::UnRegisterCategories, 1 }, // @pymeth UnRegisterCategories|Unregister one or more previously registered categories.
	{ "RegisterClassImplCategories", PyICatRegister::RegisterClassImplCategories, 1 }, // @pymeth RegisterClassImplCategories|Registers the class as implementing one or more component categories.
	{ "UnRegisterClassImplCategories", PyICatRegister::UnRegisterClassImplCategories, 1 }, // @pymeth UnRegisterClassImplCategories|Unregisters the class as implementing one or more component categories.
	{ "RegisterClassReqCategories", PyICatRegister::RegisterClassReqCategories, 1 }, // @pymeth RegisterClassReqCategories|Registers the class as requiring one or more component categories.
	{ "UnRegisterClassReqCategories", PyICatRegister::UnRegisterClassReqCategories, 1 }, // @pymeth UnRegisterClassReqCategories|Unregisters the class as requiring one or more component categories.
	{ NULL }
};

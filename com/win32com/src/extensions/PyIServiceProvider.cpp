...
// @pymethod <o PyIUnknown>|PyIServiceProvider|QueryService|Creates or accesses the specified service and returns an interface object to the specified interface for the service.
PyObject *PyIServiceProvider::QueryService(PyObject *self, PyObject *args)
{
    PyObject *obiid, *obclsid;
	if ( !PyArg_ParseTuple(args, "OO:QueryService",
...
PyComTypeObject PyIServiceProvider::type("PyIServiceProvider",
                 ...
                 sizeof(PyIServiceProvider),
                 PyIServiceProvider_methods,
